...
def run_test_practice_problem2a():
    ...
    # Test 3:
    expected = [13, 22, 66, 5, 12]
    actual = practice_problem2a([13, 22, 66, 5, 12], 0)
    print('expected:', expected)
    print('actual:', actual)

    # Test 4:
    expected = [54, 33, 86, 73, 786, 22, 15]
    actual = practice_problem2a([44, 23, 76, 63, 776, 12, 5], 10)
    print('expected:', expected)
    print('actual:', actual)
